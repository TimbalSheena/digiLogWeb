            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs mt-4">
                        <li class="btn-block"><a href="{{ route('reg_data') }}"class="btn btn-primary mb-3 btn-block active text-dark" style="background-color:#FDB417"  >Security Personnel</a></li>
                        ...
                        <li class="btn-block"><a href="{{ route('reg_office') }}"class="btn btn-primary  mb-3 btn-block text-dark" style="background-color:#FDB417" >Office</a></li>
                    </ul>
                </div>
            </div>
        </div>
