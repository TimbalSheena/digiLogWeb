<?php echo $__env->make('includes.adminheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 ...
 <a href="<?php echo e(route('admin')); ?>" class="btn btn-default" ><span class="fas fa-arrow-left mr-2"></span >Back</a>  
    <ul class="nav nav-pills justify-content-center nav-fill" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" data-toggle="pill" href="#home" style= "background-color:#FDB417">All Visit</a>
        </li>
            <li class="nav-item">
...
<div class="tab-content">
  ...
  <div class="row border border-right-0 border-bottom-0">
    ...
    <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate d-none d-sm-inline-block bg-light text-muted">
      <h5 class="row align-items-center">
        <span cla  ss="date col-1">31</span>
      ...
      <div class="row">
        <div class="form-group mb-2">
            <form class="form-inline">
                ...
                <a href="<?php echo e(route('report')); ?>" type="submit" class="btn btn-primary btn-lg mb-2 fas fa-clipboard-list mr-2 ml-2" ></a>
            </form>
...
<?php /**PATH E:\digiLogWeb-main use to modify code\resources\views//admin/all_visit.blade.php ENDPATH**/ ?>