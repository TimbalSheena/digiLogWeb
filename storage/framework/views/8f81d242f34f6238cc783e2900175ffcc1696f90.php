            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs mt-4">
                        <li class="btn-block"><a href="<?php echo e(route('reg_data')); ?>"class="btn btn-primary mb-3 btn-block active text-dark" style="background-color:#FDB417"  >Security Personnel</a></li>
...
</div><?php /**PATH E:\digiLogWeb-main use to modify code\resources\views/admin/reg_data.blade.php ENDPATH**/ ?>