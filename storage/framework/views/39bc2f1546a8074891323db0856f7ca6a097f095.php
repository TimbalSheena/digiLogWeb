        ...
        <div class="col-sm-4">
            <div class="card">
                ...
                <ul class="nav nav-tabs mt-4">
                        ...
                        <li class="btn-block"><a href="<?php echo e(route('reg_staff')); ?>"class="btn btn-primary  mb-3 btn-block active text-dark" style="background-color:#FDB417"  >Office Staff</a></li>
                        <li class="btn-block"><a href="<?php echo e(route('reg_office')); ?>"class="btn btn-primary  mb-3 btn-block text-dark" style="background-color:#FDB417" >Office</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
</div><?php /**PATH E:\digiLogWeb-main use to modify code\resources\views/admin/register/reg_staff.blade.php ENDPATH**/ ?>